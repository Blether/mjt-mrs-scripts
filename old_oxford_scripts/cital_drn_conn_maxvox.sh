#!/bin/bash
#
# do connectivity analysis of the faces data using max drn voxel as
# as seed region
#
# mjt 2009-02-22
...
HAB_ROI=${WORKDIR}/drn_correl/drn_mask
HAB_ROI_SUBJ=${OUTDIR}/${SUBJNO}_drn_ROI
AMYG_TS=${OUTDIR}/${SUBJNO}_drn_maxvox_ts.txt
...
MASTER_FSF=${WORKDIR}/drn_correl/master_design.fsf
