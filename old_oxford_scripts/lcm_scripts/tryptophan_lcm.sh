...
# $3 TE
#
datadir="/home/fs0/taylor/scratch/tryptophan/press_scans"
outdir="/home/fs0/taylor/scratch/tryptophan/lcm_output"
...
echo " FILPS='$outdir/te$3/$1_$2.ps'" >> $controlfile
echo " FILTAB='$outdir/te$3/$1_$2.table'" >> $controlfile
